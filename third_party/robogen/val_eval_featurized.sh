...
DATASET_PREFIX=/home/ktsim/Projects/SAM2Act/sam2act/data_articubot/insert_onto_square_peg_clipfeats

echo ${DATASET_PREFIX}/${TASK,,}/
echo _${TASK}
cd third_party/robogen/
torchrun --standalone --nproc_per_node=$NP val_eval_featurized.py \
    --batch_size $BS \
    --num_epochs $EPOCHS \
    ...
    --gmm \
    --load_model_path /home/ktsim/checkpoints/pointnet2_text_10k_model_invariant_2025-10-15_use_all_data_insert_onto_square_peg-obj_one_hot_use_text_gmm_clip_features/model_300.pth \
    # --wandb
