...
# DATASET_PREFIX=/home/ktsim/Projects/SAM2Act/data/put_money_in_safe_colosseum
echo ${DATASET_PREFIX}/${TASK,,}/
echo _${TASK}
cd third_party/robogen/
torchrun --standalone --nproc_per_node=$NP train_ddp_binary_collision.py \
    --batch_size $BS \
    --num_epochs $EPOCHS \
    ...
    --exp_name _just_collision_reduction \
    --use_all_data \
    --use_color \
    --use_text \
